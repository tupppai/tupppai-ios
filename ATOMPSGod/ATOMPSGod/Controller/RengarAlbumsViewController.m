...
-(void)setupNavBar {
    ...
    [[barButton rac_signalForControlEvents:UIControlEventTouchDown]subscribeNext:^(id x) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (fetchResult.count >= 1) {
        [imageManager requestImageForAsset:fetchResult[fetchResult.count - 1]
                                targetSize:CGSizeMake(cell.imageView1.frame.size.width*SCREEN_SCALE, cell.imageView1.frame.size.height*SCREEN_SCALE)
