...
/* Variables */
@interface Old_PIEEliteViewController ()
...
/* Protocols */
@interface Old_PIEEliteViewController (TableView)
...
@interface Old_PIEEliteViewController (RefreshBaseTableView)
<PWRefreshBaseTableViewDelegate>
@end

@interface Old_PIEEliteViewController (PIEShareView)
<PIEShareViewDelegate>
@end

@interface Old_PIEEliteViewController (SwipeView)
<SwipeViewDelegate,SwipeViewDataSource>
@end

@interface Old_PIEEliteViewController (DZNEmptyDataSet)
<DZNEmptyDataSetDelegate,DZNEmptyDataSetSource>
@end

@interface Old_PIEEliteViewController (JGActionSheet)
<JGActionSheetDelegate>
@end

@implementation Old_PIEEliteViewController
