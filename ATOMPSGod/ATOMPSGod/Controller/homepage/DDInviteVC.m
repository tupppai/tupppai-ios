...
//    [DDShareManager postSocialShare:ID withSocialShareType:ATOMShareTypeWechatMoments withPageType:type];
//}
//
//- (void)clickWXFriendInviteButton:(UIButton *)sender {
//    NSInteger ID = [[_info objectForKey:@"ID"]integerValue];
//    int type = [[_info objectForKey:@"type"]intValue];
//    [DDShareManager postSocialShare:ID withSocialShareType:ATOMShareTypeWechatFriends withPageType:type];
//}
//
