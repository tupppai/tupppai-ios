...
#define leastHeight kPadding15 * 2 + KAvatarWidth
...
//    [self addSubview:_userNameLabel];
    ...
    _praiseButton = [CommentLikeButton new];
    [self addSubview:_praiseButton];
}

- (void)layoutSubviews {
    [super layoutSubviews];
    _userHeaderButton.frame = CGRectMake(kPadding15, kPadding15, KAvatarWidth, KAvatarWidth);
...
+ (CGSize)calculateCommentDeailTextSize:(NSString *)commentDetailStr {
    ...
    CGSize actualSize = [commentDetailStr boundingRectWithSize:CGSizeMake(SCREEN_WIDTH - kPadding15 * 3 - KAvatarWidth, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin |                 NSStringDrawingUsesFontLeading attributes:attributeDic context:NULL].size;
    return actualSize;
}
