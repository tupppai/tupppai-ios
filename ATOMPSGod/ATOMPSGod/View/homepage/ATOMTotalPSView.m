...
- (NSDictionary *)attributeDict {
    if (!_attributeDict) {
        _attributeDict = [NSDictionary dictionaryWithObjectsAndKeys:[UIFont systemFontOfSize:kFont14], NSFontAttributeName, [UIColor colorWithHex:0xacb8c1], NSForegroundColorAttributeName, nil];
    }
...
- (void)drawRect:(CGRect)rect {
    ...
    UIBezierPath *circlePath = [UIBezierPath bezierPathWithOvalInRect:CGRectMake(_number.length * kFont14, 4, 6, 6)];
    [[UIColor colorWithHex:0xc5cdd3] set];
    [circlePath fill];
    NSString *str = @"P过";
