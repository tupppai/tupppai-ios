...
- (void)createSubView {
    _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(CGWidth(self.frame) / 2 - 13, 6, 13, 13)];
    [self addSubview:_imageView];
    _label = [[UILabel alloc] initWithFrame:CGRectMake(CGWidth(self.frame) / 2 + kPadding5, 0, CGWidth(self.frame) / 2, CGHeight(self.frame))];
